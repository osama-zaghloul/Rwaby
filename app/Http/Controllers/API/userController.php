...
class userController extends BaseController
{
    ...
    public function register(Request $request)
    {
            ...
            [
                ...
                'email.unique'          => 'تم اخذ هذا الإيميل سابقا',
    ...
    public function login(Request $request)
    {
        ...
        if(Auth::attempt(['email' => $request->email , 'password' => $request->password , 'suspensed' => 0 ])|| Auth::attempt(['phone' => $request->email , 'password' => $request->password , 'suspensed' => 0 ])) 
        {
            $user                 = Auth::user();
        ...
        {
            $errormessage = 'الإيميل او كلمة المرور غير صحيحة';
